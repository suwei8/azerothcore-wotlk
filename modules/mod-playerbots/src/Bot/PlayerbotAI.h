...
enum PvPDifficulty : uint8
{
    PVP_DIFFICULTY_NONE      = 0,
    PVP_DIFFICULTY_BRONZE    = 1,
    PVP_DIFFICULTY_PLATINUM  = 2,
    PVP_DIFFICULTY_GLADIATOR = 3
};
...
public:
    ...
    void SetPvPDifficulty(uint8 diff) { pvpDifficulty = diff; }
    uint8 GetPvPDifficulty() const { return pvpDifficulty; }
